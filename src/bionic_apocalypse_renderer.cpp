...
void Renderer::drawBattleUI(const Player &player) {
    ...
    if (moves[0]) {
        ...
        drawText("Crowbar Strike", RELATIVE_X0 + LEFT_BORDER + 30, RELATIVE_Y0 + VERTICAL_SPACING + 5, 133, 125, 125);
    }
    ...
    if (moves[1]) {
        ...
        drawText("Bandage Wounds", RELATIVE_X0 + LEFT_BORDER + 30, RELATIVE_Y0 + PREV_BOX_HEIGHT + VERTICAL_SPACING + 5, 133, 125, 125);
    }
    ...
    if (moves[3]) {
        ...
        drawText("Block Attack", RELATIVE_X0 + LEFT_BORDER + 30, RELATIVE_Y0 + 3*PREV_BOX_HEIGHT + VERTICAL_SPACING + 5, 133, 125, 125);
    }
    ...
    if (moves[4]) {
        ...
        drawText("Molotov", RELATIVE_X0 + LEFT_BORDER + 30, RELATIVE_Y0 + 4*PREV_BOX_HEIGHT + VERTICAL_SPACING + 5, 133, 125, 125);
    }
    ...
    if (moves[5]) {
        ...
        drawText("Electric Crowbar Strike", RELATIVE_X0 + LEFT_BORDER + 30, RELATIVE_Y0 + 5*PREV_BOX_HEIGHT + VERTICAL_SPACING + 5, 133, 125, 125);
    }
    ...
    if (moves[6]) {
        ...
        drawText("Time Bomb", RELATIVE_X0 + 2*LEFT_BORDER + ACTION_BOX_WIDTH + 30, RELATIVE_Y0 + VERTICAL_SPACING + 5, 133, 125, 125);
    }
    ...
    if (moves[7]) {
        ...
        drawText("Electric Net", RELATIVE_X0 + 2*LEFT_BORDER + ACTION_BOX_WIDTH + 30, RELATIVE_Y0 + 2*VERTICAL_SPACING + ACTION_BOX_HEIGHT + 5, 133, 125, 125);
    }
    ...
    if (moves[8]) {
        ...
        drawText("Trip Enemy", RELATIVE_X0 + 2*LEFT_BORDER + ACTION_BOX_WIDTH + 30, RELATIVE_Y0 + 3*VERTICAL_SPACING + 2*ACTION_BOX_HEIGHT + 5, 133, 125, 125);
    }
    ...
    if (moves[9]) {
        ...
        drawText("Small Nuclear Bomb", RELATIVE_X0 + 2*LEFT_BORDER + ACTION_BOX_WIDTH + 40, RELATIVE_Y0 + 4*VERTICAL_SPACING + 3*ACTION_BOX_HEIGHT + 5, 133, 125, 125);
    }
    ...
    if (moves[10]) {
        ...
        drawText("Large Nuclear Bomb", RELATIVE_X0 + 2*LEFT_BORDER + ACTION_BOX_WIDTH + 40, RELATIVE_Y0 + 5*VERTICAL_SPACING + 4*ACTION_BOX_HEIGHT + 5, 133, 125, 125);
    }
